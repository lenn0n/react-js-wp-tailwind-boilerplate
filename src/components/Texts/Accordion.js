export default `import { Accordion } from 'flowbite-react'
...
<Accordion>
  <Accordion.Panel>
  ...
  <Accordion.Panel>
    ...
    <Accordion.Content>
      <p className="mb-2 text-gray-500 dark:text-gray-400">
        ...
        Figma software so everything you see in the library
        has a design equivalent in our Figma file.
      </p>
      <p className="text-gray-500 dark:text-gray-400">
        Check out the
        <a href="https://flowbite.com/figma/" className="text-cyan-600 
