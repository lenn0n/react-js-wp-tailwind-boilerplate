									...
									<Popover
										...
										content={
											<div className="text-sm text-gray-500 dark:text-gray-400 shadow">
												<div className="px-3">
													<ul>
														<li className=' py-2 pe-3 border-b border-gray-300' role="button" onClick={() => handleNavigate("user/role/edit")}>
															Edit
														</li>
							...
							<ul>
								<li className='[&:not(:last-child)]:border-b border-gray-500 px-4 py-3'>
									<div className="flex flex-row items-center justify-between">
										<h6 className='text-primary font-NotoSansBold text-base'>Role</h6>
								...
								<li className='[&:not(:last-child)]:border-b border-gray-500 px-4 py-3'>
									<div className="flex flex-row items-center justify-between">
										<h6 className='text-primary font-NotoSansBold text-base'>Permissions</h6>
										<span className="font-NotoSansBold text-gray-900 whitespace-nowrap dark:text-white">
											8
										</span>
									</div>
								...
								<li className='[&:not(:last-child)]:border-b border-gray-500 px-4 py-3'>
									<div className="flex flex-row items-center justify-between">
										<h6 className='text-primary font-NotoSansBold text-base'>Restrictions</h6>
										<span className="font-NotoSansBold text-gray-900 whitespace-nowrap dark:text-white">
											28
										</span>
									</div>
													...
													<div className="text-sm text-gray-500 dark:text-gray-400 shadow">
														<div className="px-3">
															<ul>
																...
																<li className=' py-2 pe-3' role="button" onClick={() => handleRemoveModal("remove")}>
																	Remove
																</li>
															</ul>
														</div>
